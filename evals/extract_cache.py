...
from smem.system import build_llm, extract_extra_body
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"  degenerate greedy outputs {extractor.n_looped}, of which the sampled retry "
          f"(t={cfg.extract.loop_retry_temperature}) fixed {extractor.n_loop_fixed}")
